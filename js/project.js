...
if (!currentProject) {
    ...
    const projectTitle =
        document.querySelector("[data-project-title]");

    const projectCategory =
        document.querySelector("[data-project-category]");

    const projectPreview =
        document.querySelector("[data-project-preview]");
        const projectCover =
    document.querySelector("[data-project-cover]");

    const projectDescription =
        document.querySelector("[data-project-description]");

    const projectTask =
        document.querySelector("[data-project-task]");

    const projectSolution =
        document.querySelector("[data-project-solution]");

    const projectResult =
        document.querySelector("[data-project-result]");

    const projectGallery =
        document.querySelector("[data-project-gallery]");
    ...
    if (projectCover) {
        ...
        if (currentProject.cover) {
            ...
            projectCover.innerHTML = `
                <span data-project-preview>
                    ${currentProject.preview || "PROJECT"}
                </span>
            `;
        }
    }
    ...
    const lightboxCounter =
        document.querySelector("[data-lightbox-counter]");
    ...
    if (
        ...
        /*
           PDF.js работает на GitHub Pages.
